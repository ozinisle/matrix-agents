...
use MatrixAgentsAPI\Security\JWT\Helper\DateTime;
use Carbon\Carbon;
use MatrixAgentsAPI\Security\JWT\Helper\Secret;
...
class TokenBuilder extends TokenAbstract
{
     ...
     */
    public function setAudience(string $audience) : TokenBuilder
    {
     ...
     */
    public function setSubject(string $subject) : TokenBuilder
    {
